            ...
            <div className="flex-1">
              <nav className="text-sm mb-4" aria-label="Breadcrumb">
                <ol className="list-reset flex text-gray-500">
                  ...
                  <li className="text-gray-700 font-semibold">{orchid.orchidName || 'Loading...'}</li>
                </ol>
              </nav>
              <span className="inline-block bg-indigo-100 text-indigo-800 px-3 py-1 rounded mb-3 font-semibold">{orchid.orchidName || 'Loading...'}</span>
              <div className="bg-white rounded-xl shadow-lg mt-3">
                <div className="border-b px-6 py-4">
                  <p className="text-indigo-700 font-semibold text-lg">{orchid.description || 'Loading...'}</p>
                </div>
                <hr />
                <div className="px-6 py-4">
                  {orchid.isNatural ? (
                    <span className="inline-block bg-green-100 text-green-800 px-3 py-1 rounded font-semibold">This Orchid is a natural product</span>
                  ) : (
                    <span className="inline-block bg-yellow-100 text-yellow-800 px-3 py-1 rounded font-semibold">This Orchid is an industrial product</span>
                  )}
                </div>
              </div>
            </div>
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              {orchid.image && (
                <img
                  ...
                  className="my-3 w-60 h-60 object-cover rounded shadow-lg"
                />
              )}
            </div>
          </div>
